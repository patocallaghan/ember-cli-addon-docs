  ...
  _createClass(DOMAssertions, [{
    ...
    value: function hasText(expected, message) {
      ...
      if (expected instanceof RegExp) {
        ...
        var _actual3 = collapseWhitespace(element.textContent);
        var _result3 = _actual3 === expected;

        if (!message) {
          message = 'Element ' + this.targetDescription + ' has text "' + expected + '"';
        }

        this.pushResult({ result: _result3, actual: _actual3, expected: expected, message: message });
      }
    }
    ...
    value: function hasValue(expected, message) {
      ...
      if (expected instanceof RegExp) {
        ...
        var _result4 = Boolean(element.value);

        var _expected3 = 'Element ' + this.targetDescription + ' has a value';
        var _actual4 = _result4 ? _expected3 : 'Element ' + this.targetDescription + ' has no value';

        if (!message) {
          message = _expected3;
        }

        this.pushResult({ result: _result4, actual: _actual4, expected: _expected3, message: message });
      } else {
        var _actual5 = element.value;
        var _result5 = _actual5 === expected;

        if (!message) {
          message = 'Element ' + this.targetDescription + ' has value "' + expected + '"';
        }

        this.pushResult({ result: _result5, actual: _actual5, expected: expected, message: message });
      }
    }
...
define('ember-classy-page-object/-private/page-object', ['exports', 'ember-cli-page-object/extend', 'ember-classy-page-object/-private/utils/create', 'ember-classy-page-object/-private/utils/deep-merge-descriptors', 'ember-classy-page-object/-private/utils/extract-getters'], function (exports, _extend, _create, _deepMergeDescriptors, _extractGetters) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.PageObject = undefined;
  ...
  class PageObject {
    ...
    extend(extension) {
      ...
      let finalizedDefinition = (0, _deepMergeDescriptors.default)((0, _extractGetters.default)(extension), this.definition);
    ...
    create() {
      return (0, _create.default)(this.definition);
    }
  }

  exports.PageObject = PageObject;
  exports.default = new PageObject({});
});
define('ember-classy-page-object/-private/properties/collection', ['exports', 'ceibo', 'ember-cli-page-object', 'ember-cli-page-object/extend', 'ember-classy-page-object/-private/utils/create', 'ember-classy-page-object/-private/utils/extract-getters'], function (exports, _ceibo, _emberCliPageObject, _extend, _create, _extractGetters) {
  'use strict';
  ...
  class CollectionProxy {
    constructor(definition, parent, key) {
      ...
      this._countPage = (0, _create.default)({ count: (0, _emberCliPageObject.count)(definition.scope) }, { parent });
    ...
    eq(index) {
      if (this._items[index] === undefined) {
        ...
        let scope = (0, _extend.buildSelector)({}, definition.scope, { at: index });

        let finalizedDefinition = (0, _extractGetters.default)(definition);
        finalizedDefinition.scope = scope;

        let tree = (0, _create.default)(finalizedDefinition, { parent });
    ...
    findOne(query) {
      ...
      (true && !(result.length <= 1) && Ember.assert(`Expected at most one result from findOne query, but found ${result.length}`, result.length <= 1));
    ...
    findAll(query) {
      ...
      if (typeof query === 'object') {
        ...
        (true && !(false) && Ember.assert(`Expected query for findAll to be either an object or function, received: ${query}`, false));
      }
...
define('ember-classy-page-object/-private/utils/create', ['exports', 'ember-cli-page-object', 'ember-cli-page-object/-private/dsl'], function (exports, _emberCliPageObject, _dsl) {
  'use strict';
  ...
  const builder = {
    object(node, blueprintKey, blueprint, defaultBuilder) {
      let finalizedBlueprint = Object.assign({}, _dsl.default);
  ...
  function create(blueprint, options) {
    return (0, _emberCliPageObject.create)(blueprint, Object.assign({ builder }, options));
  }
});
define('ember-classy-page-object/-private/utils/deep-merge-descriptors', ['exports'], function (exports) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = deepMergeDescriptors;
...
define('ember-classy-page-object/-private/utils/extract-getters', ['exports', 'ember-cli-page-object/macros'], function (exports, _macros) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = extractGetters;
